...
class DataValidation:
    ...
    def is_train_test_file_exists(self)->bool:
        try:
            ...
            logging.info(f"Is train and test exists ? -> {is_available}")

            if not is_available:
                training_file = self.data_ingestion_artifact.train_file_path
                test_file  = self.data_ingestion_artifact.test_file_path
                message = f"Training file: {training_file} or Testing_file: {test_file}"\
                    "is not present"
    ...
    def get_and_save_data_drift_report(self):
        try:
            ...
            report_dir = os.path.join(report_file_path)
    ...
    def save_data_drift_reprot_page(self):
        try:
    ...
    def is_data_drift_found(self) -> bool:
        try:
            ...
            self.save_data_drift_reprot_page()
            return True
